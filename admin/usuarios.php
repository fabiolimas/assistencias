...
<head>
    ...
    $("#buscar").keyup(function(){
        ...
        if(pesquisa != null){
            ...
            $.post('lista_usuarios.php', dados, function(retorna){
...
<body>
    ...
    <header id="cabecalho"> 
       ...
       <input type="checkbox" name="" checked id="btMenu">
        ...
        <nav id="menu">
            ...
            <ul>
                <li title="Usuários Cadastrados" style="background:#07dea6">
	...
	<form method="post" action="#">
		...
		Buscar: 
		<input type="text" name="buscar" placeholder="Nome do usuário" title="Buscar pelo nome de usuário" id="buscar">
