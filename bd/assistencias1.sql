...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 16-Jun-2020 às 14:10
...
CREATE TABLE IF NOT EXISTS `garantias` (
  ...
  `data_garantia` varchar(40) NOT NULL,
  `avaria` varchar(200) NOT NULL,
  `motivo` varchar(250) DEFAULT NULL,
  `id_status_fornecedor` int(4) DEFAULT NULL,
  `id_status_garantia` int(4) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `loja_fk` (`id_loja`),
  KEY `mercadoria_fk` (`id_mercadoria`),
  KEY `status_fornecedor_fk` (`id_status_fornecedor`),
  KEY `status_garantia_fk` (`id_status_garantia`)
...
INSERT INTO `garantias` (`id`, `id_loja`, `cliente`, `cpf`, `id_mercadoria`, `marca`, `descricao`, `os`, `nota_fiscal`, `data_venda`, `data_garantia`, `avaria`, `motivo`, `id_status_fornecedor`, `id_status_garantia`) VALUES
(14, 120, 'FABIO MOREIRA LIMA', '03508401561', 801121, 'RAYBAN', 'RB332211', '8874744', '11236', '2020-04-10', '2020-06-10', 'LENTE TRINCADA', NULL, NULL, 4),
(15, 100, 'RUBENS AUGUSTO', '12345789698', 8011212, 'ANA HICKMAN', 'AH5585', '10121', '25', '2020-04-02', '2020-06-10', 'PEÇA DESCASCANDO', NULL, NULL, 4),
(16, 700, 'HENRIQUE DA SILVA', '77814577889', 8101121, 'POLAROID', 'PL5544', '21001', '233', '2020-04-02', '2020-06-08', 'QUEBROU TODO', NULL, NULL, 4),
(17, 900, 'SILVANA SOUZA', '99874421144', 9013633, 'ZARCO', 'ZA6698', '8011123', '66932', '2020-02-05', '2020-06-08', 'HASTE QUEBROU', NULL, NULL, 4),
(18, 900, 'FABIO MOREIRA LIMA', '03508401561', 8011212, 'RAYBAN', 'RB332211', '333333', '11236', '2020-06-05', '2020-06-10', 'QUEBROU', '', NULL, 4),
(19, 700, 'HENRIQUE DA SILVA', '77814577889', 8101121, 'ANA HICKMAN', 'AH5585', '444', '2532', '2020-06-03', '2020-06-09', 'OUTRO QUEBRADO', '', NULL, 4);
...
INSERT INTO `lojas` (`id_loja`, `loja`, `rsocial`, `cnpj`, `inscest`, `inscmun`, `endereco`, `numero`, `bairro`, `cidade`, `uf`, `fone`, `status`) VALUES
(100, 'JACOBINA', 'JOSÉ LUCIANO VIEIRA COSTA', '1612112300010', '11265', 'ISENTO', 'AVENIDA ORLANDO OLIVEIRA PIRES', '206', 'CENTRO', 'JACOBINA', 'BA', '7436217900', 1),
(120, 'PETROLINA', 'FOTOGRAFIA DIGITAL', '12025547854112', '2255878', 'ISENTO', 'AVENIDA GUARARAPES', '10', 'CENTRO', 'PETROLINA', 'PE', '87336212125', 1),
(700, 'SENHOR DO BONFIM', 'JOSÉ LUCIANO VIEIRA COSTA', '70011225112125', '5569898', 'ISENTO', 'CALÇADÃO', '336', 'CENTRO', 'SENHOR DO BONFIM', 'BA', '7499866521', 1),
(900, 'CAPIM GROSSO', 'MARILDA MACEDO', '23321123300012', 'ISENTO', 'ISENTO', 'RUA DOS PAIAIÁ', '25', 'CENTRO', 'CAPIM GROSSO', 'BA', '7436653322', 1);
...
CREATE TABLE IF NOT EXISTS `mercadorias` (
  `mercadoria` int(6) NOT NULL AUTO_INCREMENT,
  `descricao` varchar(100) NOT NULL,
  `marca` varchar(50) NOT NULL,
  PRIMARY KEY (`mercadoria`)
) ENGINE=InnoDB AUTO_INCREMENT=810721 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `mercadorias`
--

INSERT INTO `mercadorias` (`mercadoria`, `descricao`, `marca`) VALUES
(810720, 'ARM. OK8069 OAKLEY ACET.', 'OAKLEY');

-- --------------------------------------------------------

--
-- Estrutura da tabela `status_fornecedor`
--

DROP TABLE IF EXISTS `status_fornecedor`;
CREATE TABLE IF NOT EXISTS `status_fornecedor` (
  `id_status_fornecedor` int(4) NOT NULL AUTO_INCREMENT,
  `status_fornecedor` varchar(50) NOT NULL,
  PRIMARY KEY (`id_status_fornecedor`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `status_fornecedor`
--

INSERT INTO `status_fornecedor` (`id_status_fornecedor`, `status_fornecedor`) VALUES
(1, 'Aceito'),
(2, 'Recusado'),
...
DROP TABLE IF EXISTS `status_garantia`;
CREATE TABLE IF NOT EXISTS `status_garantia` (
...
INSERT INTO `status_garantia` (`id_status`, `status`) VALUES
(1, 'Concluida'),
(3, 'Cancelada'),
(4, 'Aguardando'),
(5, 'Recusada');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `permissao` int(2) NOT NULL DEFAULT '0',
...
INSERT INTO `usuarios` (`id`, `nome`, `email`, `telefone`, `usuario`, `senha`, `permissao`, `status`) VALUES
(6, 'ADMINISTRADOR', 'fabiolima01@live.com', '74991381274', 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1, 1),
(7, 'MAURÍCIA', 'confere@fotoimagem.com.br', '7436217900', 'mauricia', '77c12394ef7d4f23a8fa07d87309afd9', 0, 1);
...
ALTER TABLE `garantias`
  ADD CONSTRAINT `loja_fk` FOREIGN KEY (`id_loja`) REFERENCES `lojas` (`id_loja`),
  ADD CONSTRAINT `status_fornecedor_fk` FOREIGN KEY (`id_status_fornecedor`) REFERENCES `status_fornecedor` (`id_status_fornecedor`),
  ADD CONSTRAINT `status_garantia_fk` FOREIGN KEY (`id_status_garantia`) REFERENCES `status_garantia` (`id_status`);
COMMIT;
